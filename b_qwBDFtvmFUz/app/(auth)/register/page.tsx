  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1490481651871-ab68de25d43d?w=1200&q=80')] bg-cover bg-center opacity-30" />
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-md">
            Join thousands of fashion enthusiasts who have transformed their wardrobe with AI-powered styling.
          </p>
